          ...
          <div className="p-4 rounded-xl border border-border space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Use the download buttons above, then share the file manually</p>
              </div>
            </div>
            <p className="text-xs text-muted-foreground">Download your report as PDF or PPTX using the buttons above, then attach it to any email, chat, or cloud drive.</p>
          </div>
