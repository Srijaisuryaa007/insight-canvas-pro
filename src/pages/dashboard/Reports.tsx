          ...
          <div className="p-4 rounded-xl border border-border space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Share your report link via WhatsApp or Gmail</p>
              </div>
            </div>
            <div className="flex gap-2">
              <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`Check out my data report: "${reportTitle}" — generated by DataVora`)}`}
                target="_blank" rel="noopener noreferrer" className="flex-1">
                <Button variant="outline" size="sm" className="w-full h-8 text-xs">📱 WhatsApp</Button>
              </a>
              <a href={`https://mail.google.com/mail/?view=cm&su=${encodeURIComponent(`Data Report: ${reportTitle}`)}&body=${encodeURIComponent(`Hi,\n\nPlease find attached my data report "${reportTitle}" generated by DataVora.\n\nBest regards`)}`}
                target="_blank" rel="noopener noreferrer" className="flex-1">
                <Button variant="outline" size="sm" className="w-full h-8 text-xs">📧 Gmail</Button>
              </a>
            </div>
          </div>
