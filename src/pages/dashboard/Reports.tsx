...
const TEMPLATE_STORAGE_KEY = 'datavora_report_template';
const HISTORY_KEY = 'datavora_report_history';
const NOTES_KEY = 'datavora_report_notes';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-xl border border-border space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold">Share via Apps</h4>
                <p className="text-[10px] text-muted-foreground">Copy a message to paste in WhatsApp or Gmail</p>
              </div>
            </div>
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="flex-1 h-8 text-xs" onClick={() => {
                navigator.clipboard.writeText(`Check out my data report: "${reportTitle}" — generated by DataVora`);
                toast({ title: '📱 Copied for WhatsApp!', description: 'Open WhatsApp and paste the message' });
              }}>📱 WhatsApp</Button>
              <Button variant="outline" size="sm" className="flex-1 h-8 text-xs" onClick={() => {
                navigator.clipboard.writeText(`Subject: Data Report: ${reportTitle}\n\nHi,\n\nPlease find attached my data report "${reportTitle}" generated by DataVora.\n\nBest regards`);
                toast({ title: '📧 Copied for Gmail!', description: 'Open Gmail, compose a new email, and paste' });
              }}>📧 Gmail</Button>
            </div>
          </div>
